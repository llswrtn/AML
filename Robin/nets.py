...
class simpleCNNModel(nn.Module):
    def __init__(self, dropout, imgSize, numImageChannels,outputSize):
        ...
        # Convolution 1+2:
        self.cnn1 = nn.Conv2d(in_channels=numImageChannels, out_channels=6, kernel_size=3, stride=1, padding=0)
        ...
        # Convolution 3+4:
        self.cnn3 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=3, stride=1, padding=0)
        self.bn3 = nn.BatchNorm2d(num_features=32)
        self.relu3 = nn.ReLU()
        self.cnn4 = nn.Conv2d(in_channels=32, out_channels=16, kernel_size=3, stride=1, padding=0)
        self.bn4 = nn.BatchNorm2d(16)
        self.relu4 = nn.ReLU()

        # outputsize
        outSize = math.ceil((((imgSize-4) / 2) - 4))
